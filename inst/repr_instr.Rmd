...
If you don't have the data you can use simulated data available in the OSF repository for this project. Make sure that the subdirectories `all_null`, `main_effect` and/or `interaction` are subdirectories of the working directory.
