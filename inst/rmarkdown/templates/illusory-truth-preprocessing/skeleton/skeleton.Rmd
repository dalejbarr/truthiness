...
```{r phs-excl-list}
DT::datatable(phase_keep %>% 
              filter(!keep, p_excl_reason != "Session was excluded") %>%
              select(PID, phase_id, p_excl_reason))
```
...
saveRDS(phase_share, file.path(anondir, "ANON_phases.rds"))
