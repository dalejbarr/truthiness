...
interest <- import_iratings(params$subdir)
...
readr::write_csv(interest_share, file.path(params$anondir, "ANON_interest.csv"))

cat("\nWrote anonymized data to files ",
    "`ANON_sessions.csv`, `ANON_phases.csv`, `ANON_ratings.csv`, and ",
    "`ANON_interest.csv` in subdirectory `", params$anondir, "`.\n", sep = "")
