...
```{r fit-clmm-no-parallel, eval = (!parallel_installed) & params$refit, echo = (!parallel_installed)}
...
```{r fit-clmm-parallel, eval = parallel_installed & params$refit, echo = parallel_installed, results = 'asis'}
