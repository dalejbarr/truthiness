...
For information about the structure of the anonymized data files and stimulus materials, please see the documentation in the truthiness package for the data objects `sessions`, `phases`, `ratings`, and `cjudgments`.
